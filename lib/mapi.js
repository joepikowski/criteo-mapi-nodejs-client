...
class Criteo_MAPI_Client extends API_Client {
     ...
     * @param {(integer|string)} audience - Audience ID
     * @param {object} options
     * @param {string} options.schema - 'email' or 'madid'
     ...
     * @param {string} options.endDate - Starting date string, will be auto-converted to ISO for convenience
     * @param {function} [callback] - Optional callback
     */
    ...
    request(method, path, data){
        return this[method]({
            ...
            'headers': {
                ...
                'User-Agent': 'criteo-nodejs-client/0.8'
            }
        });
    }
}
