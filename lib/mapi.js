...
class Criteo_MAPI_Client extends API_Client {
     ...
     * @param {string} [options.endAfterDate] - Filter for budgets ending after a certain date, will be auto-converted to ISO for convenience
     * @param {string} [options.startBeforeDate] - Filter for budgets starting before a certain date, will be auto-converted to ISO for convenience
     * @param {(integer|string)} [options.campaignId]
     * @param {string} [options.type]
     * @param {function} [callback] - Optional callback
     */
    getCRPBudgetsBySeller(id, options = {}){
        const data = {
            'status': options.status,
            'withBalance': options.withBalance,
            'withSpend': options.withSpend,
            'sellerName': options.sellerName,
            'endAfterDate': new Date(options.endAfterDate).toISOString(),
            'startBeforeDate': new Date(options.startBeforeDate).toISOString(),
     ...
     * @param {function} [callback] - Optional callback
     */
    getCRPCampaignsBySeller(id, options = {}){
        const data = {
            'sellerStatus': options.sellerStatus,
            'campaignId': options.campaignId,
     ...
     * @param {(integer|string)} id - Campaign ID
     * @param {function} [callback] - Optional callback
     */
    getCRPCampaign(id){
        return this.mapiRequest({
     ...
     * @param {function} [callback] - Optional callback
     */
    getCRPBudgetsByCampaign(id, options = {}){
        const data = {
            'status': options.status,
     ...
     * @param {string} [update.startDate] - Start date of the budget, will be auto-converted to ISO for convenience
     * @param {string} [update.endDate] - End date of the budget, will be auto-converted to ISO for convenience
     * @param {(integer[]|string[])} [update.campaignIds]
     * @param {boolean} [update.isSuspended]
     * @param {function} [callback] - Optional callback
     */
    updateCRPBudget(id, update = {}){
        return this.mapiRequest({
            'method': 'patch',
            'path': `/v2/crp/budgets/${id}`,
     ...
     * @param {string} [budgets[].startDate] - Start date of the budget, will be auto-converted to ISO for convenience
     * @param {string} [budgets[].endDate] - End date of the budget, will be auto-converted to ISO for convenience
     * @param {(integer[]|string[])} [budgets[].campaignIds]
     * @param {boolean} [budgets[].isSuspended]
     * @param {function} [callback] - Optional callback
     */
    updateCRPBudgets(budgets = []){
        return this.mapiRequest({
            'method': 'patch',
            'path': `/v2/crp/budgets`,
     ...
     * @param {string} [budgets[].endDate] - End date of the budget, will be auto-converted to ISO for convenience
     * @param {(integer[]|string[])} [budgets[].campaignIds]
     * @param {string} [budgets[].budgetType]
     * @param {(integer|string)} [budgets[].sellerId]
     * @param {function} [callback] - Optional callback
     */
    createCRPBudgets(budgets = []){
        return this.mapiRequest({
            'method': 'post',
            'path': `/v2/crp/budgets`,
            'data': JSON.stringify(budgets),
     ...
     * @param {function} [callback] - Optional callback
     */
    getCRPStatsBySellerCampaign(options = {}){
        const data = {
            'intervalSize': options.intervalSize,
            'clickAttributionPolicy': options.clickAttributionPolicy,
            'startDate': new Date(options.startDate).toISOString(),
